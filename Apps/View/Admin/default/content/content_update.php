...
\App::$Alias->setCustomLibrary('css', \App::$Alias->scriptUrl . '/vendor/bower/bower-asset/blueimp-file-upload/css/jquery.fileupload.css');
\App::$Alias->setCustomLibrary('js', \App::$Alias->scriptUrl . '/vendor/bower/bower-asset/blueimp-file-upload/js/vendor/jquery.ui.widget.js');
\App::$Alias->setCustomLibrary('js', \App::$Alias->scriptUrl . '/vendor/bower/bower-asset/blueimp-file-upload/js/jquery.iframe-transport.js');
\App::$Alias->setCustomLibrary('js', \App::$Alias->scriptUrl . '/vendor/bower/bower-asset/blueimp-file-upload/js/jquery.fileupload.js');
?>
