...
<body>
<table align="center" cellspacing="0" border="0" cellpadding="0" width="580" bgcolor="#FFFFFF" style="width:580px;background-color:#FFF;border-top:1px solid #DDD;border-bottom:1px solid #DDD;">
    <tbody>
    <tr>
            ...
            <table cellspacing="0" border="0" cellpadding="0" width="500" align="left">
                ...
                <tr>
                    <td align="left" style="font-family:Helvetica Neue,Arial,Helvetica,sans-serif;padding-left:9px;font-size:14px;">
                        <a href="<?= \App::$Alias->scriptUrl ?>/user/recovery/<?= $id ?>/<?= $token ?>"><?= __('Change password') ?></a>
                    </td>
                </tr>
                </tbody>
            </table>
